...
const wchar_t* fontsList[FONTS_COUNT] = { L"Calibri", L"Anja Eliane", L"Lily of the Valley_Personal_Use", L"Arial", L"Courier New", L"Consolas" };
const int outAngles[29] = { 10, 9, 8, 8, 6, 6, 6, 5, 5, 4, 4, 4, 4, 4, 4, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 2};
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		...
		{
			case VK_F1:
				currStyle = ++currStyle % FONTS_COUNT;
				InvalidateRect(hWnd, NULL, true);
				break;
			case VK_F2:
...
void ShowText(HWND hWnd, const WCHAR* str, int len)
{
	...
	Font font(&FontFamily(fontsList[currStyle]), FONT_SIZE, FONT_STYLE);
